...
export interface Destination {
  ...
  name: string;
  slug: string;
  region: 'Chittagong' | 'Khulna' | 'Sylhet' | 'Barishal' | 'Dhaka' | 'Rajshahi' | 'Rangpur' | 'Mymensingh';
  ...
  hangoutType?: ('Group/Couple' | 'Solo' | 'Family') | null;
  ...
  reels?:
    | {
        creator: string;
        platform?: ('YouTube' | 'Instagram' | 'Facebook' | 'TikTok') | null;
        /**
         * YouTube watch/embed URL preferred
         */
        embedUrl?: string | null;
    ...
    | null;
  /**
   * Up to 4 related destinations
   */
  related?: (number | Destination)[] | null;
  faqs?:
    | {
        question: string;
        answer: string;
